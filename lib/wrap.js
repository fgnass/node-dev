...
var Debug = NodeDevDebug.Debug

ipc.on(process, 'modified', function(e) {
  var script = Debug.findScript(e.modified)
  var newSrc = '(function (exports, require, module, __filename, __dirname) {'
    +  fs.readFileSync(e.modified, 'utf8') + '\n});'

  Debug.LiveEdit.SetScriptSource(script, newSrc, false, [])
})
